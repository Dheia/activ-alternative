class News {
    constructor() {
        this.clientContainer = '.news-container';
        this.serverHandler = 'onListPostsUpdate';
        this.serverPartial = 'news';
        this.el = null;
    ...
    update() {
        this.framework.update({
            ...
            serverPartial: this.serverPartial,
